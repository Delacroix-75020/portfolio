    ...
    <section class="page-section bg-forum text-white mb-0" id="about">
        <div class="container">
            <!-- About Section Heading-->
            <h2 class="page-section-heading text-center text-uppercase text-white">Le Forum-Foure-Tout</h2>
            <!-- Icon Divider-->
